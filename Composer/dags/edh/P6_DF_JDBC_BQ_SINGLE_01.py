...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_01'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_single_01 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Task_Project_Financial_Prep_RN",
            "tableName": "DM_Projects_PID.RPT_CF_Task_Project_Financial_Prep_RN",
