...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_07'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_single_07 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Task_Project_Financial_UP_PPR_Forecast_Month_prep",
            "tableName": "DM_Projects_PID.RPT_CF_Task_Project_Financial_UP_PPR_Forecast_Month_prep",
