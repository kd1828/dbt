...
with models.DAG(
    ...
    jdbc_bq_multi_09 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_KPIs_Prep,RPT_LL_Prep,RPT_CX_IPS_Summary_Prep,RPT_CX_HCV_Prep,RPT_DC_KPIs_Prep,RPT_HC_KPIs_Prep,RPT_CX_Finalisation_Prep,RPT_CX_SC_Programme_Prep,RPT_CX_PPP_Detail_Rn,RPT_CF_Project_Financial_PID_Prep",
            "tableName": "DM_Projects_PID.RPT_CF_KPIs_Prep,DM_Projects_PID.RPT_LL_Prep,DM_Projects_PID.RPT_CX_IPS_Summary_Prep,DM_Projects_PID.RPT_CX_HCV_Prep,DM_Projects_PID.RPT_DC_KPIs_Prep,DM_Projects_PID.RPT_HC_KPIs_Prep,DM_Projects_PID.RPT_CX_Finalisation_Prep,DM_Projects_PID.RPT_CX_SC_Programme_Prep,DM_Projects_PID.RPT_CX_PPP_Detail_Rn,DM_Projects_PID.RPT_CF_Project_Financial_PID_Prep",
