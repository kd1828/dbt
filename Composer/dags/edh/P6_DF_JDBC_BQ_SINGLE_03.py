...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_03'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_single_03 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_HS_BBS_Events_Blend_Prep",
            "tableName": "DM_Projects_PID.RPT_HS_BBS_Events_Blend_Prep",
