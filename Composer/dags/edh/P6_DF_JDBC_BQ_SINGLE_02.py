...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_02'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_single_02 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CP_SC_Control_Sheet_KPIs_Prep",
            "tableName": "DM_Projects_PID.RPT_CP_SC_Control_Sheet_KPIs_Prep",
