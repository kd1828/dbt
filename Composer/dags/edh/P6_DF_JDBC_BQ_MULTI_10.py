...
with models.DAG(
    ...
    jdbc_bq_multi_10 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_QM_Defect_Movements_Prep,RPT_QM_KPIs_Prep,RPT_CF_Project_Payment_To_Terms_Prep,RPT_CX_Wages_Summary_Prep,RPT_HS_Audit_Assessment_Prep,RPT_PR_Contractor_Capability_Prep_RN,RPT_PP_KPIs_Prep,RPT_FI_KPIs_Prep,RPT_RO_KPIs_Prep,RPT_SU_KPIs_Prep",
            "tableName": "DM_Projects_PID.RPT_QM_Defect_Movements_Prep,DM_Projects_PID.RPT_QM_KPIs_Prep,DM_Projects_PID.RPT_CF_Project_Payment_To_Terms_Prep,DM_Projects_PID.RPT_CX_Wages_Summary_Prep,DM_Projects_PID.RPT_HS_Audit_Assessment_Prep,DM_Projects_PID.RPT_PR_Contractor_Capability_Prep_RN,DM_Projects_PID.RPT_PP_KPIs_Prep,DM_Projects_PID.RPT_FI_KPIs_Prep,DM_Projects_PID.RPT_RO_KPIs_Prep,DM_Projects_PID.RPT_SU_KPIs_Prep",
