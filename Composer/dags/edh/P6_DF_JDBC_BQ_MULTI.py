...
with models.DAG(
    ...
    jdbc_bq_multi = DataFlowJavaOperator(
        # task_id=pipeline_id.replace("_", "-").lower(),
        task_id="jdbc_bq_multi",
        poll_sleep=5,
        ...
        options={
            ...
            "BQTable": "**********RPT_HS_Frequency_Rates_Prep,RPT_CF_Project_Financial_PID_Sections_Prep*******************",
            "tableName": "*******************DM_Projects_PID.RPT_HS_Frequency_Rates_Prep,DM_Projects_PID.RPT_CF_Project_Financial_PID_Sections_Prep***********************",
