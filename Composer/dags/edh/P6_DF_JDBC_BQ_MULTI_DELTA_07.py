...
# *******************************************************************
#
# This Dag is to load EDH multiple delta load type SQL Server table data into BQ
# *******************************************************************
...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_07'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_07 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CX_SCV_Prep,RPT_CF_Project_Payment_Drilldown_Prep,RPT_HS_Acute_High_Risk_Scenarios_Prep,RPT_CF_Project_Financial_PID_Financials_Prep,RPT_CX_Subbie_Control_Sheet_Prep,RPT_HS_Events_Impacts_Prep,RPT_CF_Cashflow_Cost_Working_Cap_Phased_Prep,RPT_CX_SelfAssessControl_Prep,RPT_CX_CLM_Prep,RPT_HS_Inspections_Observations_Target_Prep",
            "tableName": "DM_Projects_PID.RPT_CX_SCV_Prep,DM_Projects_PID.RPT_CF_Project_Payment_Drilldown_Prep,DM_Projects_PID.RPT_HS_Acute_High_Risk_Scenarios_Prep,DM_Projects_PID.RPT_CF_Project_Financial_PID_Financials_Prep,DM_Projects_PID.RPT_CX_Subbie_Control_Sheet_Prep,DM_Projects_PID.RPT_HS_Events_Impacts_Prep,DM_Projects_PID.RPT_CF_Cashflow_Cost_Working_Cap_Phased_Prep,DM_Projects_PID.RPT_CX_SelfAssessControl_Prep,DM_Projects_PID.RPT_CX_CLM_Prep,DM_Projects_PID.RPT_HS_Inspections_Observations_Target_Prep",
