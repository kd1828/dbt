...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "*******************RPT_CF_Task_Project_Cashflow_Prep,**************",
            "tableName": "*****************DM_Projects_PID.RPT_CF_Task_Project_Cashflow_Prep,***************",
