...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_04'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_04 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Turnover_Accrual_Tasklevel_Prep,RPT_CF_Task_Project_Change_Orders_Prep,RPT_CF_Task_Project_Committed_Cost_Forecast_Prep,RPT_CX_Wages_Prep_2",
            "tableName": "DM_Projects_PID.RPT_CF_Turnover_Accrual_Tasklevel_Prep,DM_Projects_PID.RPT_CF_Task_Project_Change_Orders_Prep,DM_Projects_PID.RPT_CF_Task_Project_Committed_Cost_Forecast_Prep,DM_Projects_PID.RPT_CX_Wages_Prep_2",
