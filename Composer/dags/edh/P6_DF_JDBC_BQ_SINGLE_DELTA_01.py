...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_DELTA_01'
run_id = "{{ run_id }}"
...
# DAG object.
with models.DAG(
        "P6_DF_JDBC_BQ_SINGLE_DELTA_01",
        schedule_interval=None,  # every day at 0-23 run every 6 hrs:00 UTC
        default_args=default_args) as dag:
    jdbc_bq_single_delta+jdbc_bq_single_delta_01 = DataFlowJavaOperator(
        # task_id=pipeline_id.replace("_", "-").lower(),
        task_id="jdbc_bq_single_delta+jdbc_bq_single_delta_01",
        poll_sleep=5,
...
dag >> jdbc_bq_single_delta+jdbc_bq_single_delta_01