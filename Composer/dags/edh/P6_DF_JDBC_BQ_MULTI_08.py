...
with models.DAG(
    ...
    jdbc_bq_multi_08 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Task_Project_Financial_Prep_Unphased_TP_Lvl3,RPT_CP_ProjectBankGuarantee_Prep_RN,RPT_PR_Contractor_List_Prep_RN,RPT_CF_Reliance_Prep_RN,RPT_CX_GPR_Prep,RPT_CX_Salaries_Summary_Prep,RPT_PO_KPIs_Prep,RPT_CX_PPF_Prep,RPT_CP_KPIs_Prep,RPT_HS_KPIs_Prep",
            "tableName": "TEMP_ETL.RPT_CF_Task_Project_Financial_Prep_Unphased_TP_Lvl3,DM_Projects_PID.RPT_CP_ProjectBankGuarantee_Prep_RN,DM_Projects_PID.RPT_PR_Contractor_List_Prep_RN,DM_Projects_PID.RPT_CF_Reliance_Prep_RN,DM_Projects_PID.RPT_CX_GPR_Prep,DM_Projects_PID.RPT_CX_Salaries_Summary_Prep,DM_Projects_PID.RPT_PO_KPIs_Prep,DM_Projects_PID.RPT_CX_PPF_Prep,DM_Projects_PID.RPT_CP_KPIs_Prep,DM_Projects_PID.RPT_HS_KPIs_Prep",
