...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_02'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_02 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Task_Project_Cashflow_Phased_lvl6_ForAct_Prep,RPT_CF_Task_Project_Financial_Cashflow_Phased_Prep,RPT_DC_PC_Prep_RN",
            "tableName": "DM_Projects_PID.RPT_CF_Task_Project_Cashflow_Phased_lvl6_ForAct_Prep,DM_Projects_PID.RPT_CF_Task_Project_Financial_Cashflow_Phased_Prep,DM_Projects_PID.RPT_DC_PC_Prep_RN",
