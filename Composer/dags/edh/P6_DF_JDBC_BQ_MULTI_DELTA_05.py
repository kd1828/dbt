...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_05'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_05 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Contingency_Analysis_Prep_RN,RPT_CF_Task_Project_Financial_Prep_Phased_TP_Lvl3,RPT_CF_Turnover_Programme_Lvl3_Prep,RPT_PP_Planning_Programming_Prep,RPT_HS_Inspections_Prep,RPT_PG_Pegasus_Prep",
            "tableName": "DM_Projects_PID.RPT_CF_Contingency_Analysis_Prep_RN,TEMP_ETL.RPT_CF_Task_Project_Financial_Prep_Phased_TP_Lvl3,DM_Projects_PID.RPT_CF_Turnover_Programme_Lvl3_Prep,DM_Projects_PID.RPT_PP_Planning_Programming_Prep,DM_Projects_PID.RPT_HS_Inspections_Prep,DM_Projects_PID.RPT_PG_Pegasus_Prep",
