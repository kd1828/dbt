...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_06'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_06 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_HS_Frequency_Rates_Prep,RPT_CF_Project_Financial_PID_Sections_Prep,RPT_SU_Usage_Statistics_Prep,RPT_CX_PPP_Prep_2,RPT_RO_Project_Organisation_Daily_Alert_Prep,RPT_CX_Delay_Prep,RPT_RO_Project_Organisation_Performance_Prep,RPT_HS_Actions_Prep,RPT_CX_Finalisation_Details_Prep,RPT_AR_Prep",
            "tableName": "DM_Projects_PID.RPT_HS_Frequency_Rates_Prep,DM_Projects_PID.RPT_CF_Project_Financial_PID_Sections_Prep,DM_Projects_PID.RPT_SU_Usage_Statistics_Prep,DM_Projects_PID.RPT_CX_PPP_Prep_2,DM_Projects_PID.RPT_RO_Project_Organisation_Daily_Alert_Prep,DM_Projects_PID.RPT_CX_Delay_Prep,DM_Projects_PID.RPT_RO_Project_Organisation_Performance_Prep,DM_Projects_PID.RPT_HS_Actions_Prep,DM_Projects_PID.RPT_CX_Finalisation_Details_Prep,DM_Projects_PID.RPT_AR_Prep",
