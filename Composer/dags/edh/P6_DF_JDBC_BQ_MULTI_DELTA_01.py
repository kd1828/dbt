...
pei_id = 'P6_DF_JDBC_BQ_MULTI_DELTA_01'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_multi_delta_01 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_CF_Task_Project_Financial_FFC_Prep,RPT_HS_BBS_Behaviours_Prep",
            "tableName": "DM_Projects_PID.RPT_CF_Task_Project_Financial_FFC_Prep,DM_Projects_PID.RPT_HS_BBS_Behaviours_Prep",
