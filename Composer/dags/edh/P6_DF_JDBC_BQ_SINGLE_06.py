...
pei_id = 'P6_DF_JDBC_BQ_SINGLE_06'
run_id = "{{ run_id }}"
...
with models.DAG(
    ...
    jdbc_bq_single_06 = DataFlowJavaOperator(
        ...
        options={
            ...
            "BQTable": "RPT_QM_Documents_Prep",
            "tableName": "DM_Projects_PID.RPT_QM_Documents_Prep",
